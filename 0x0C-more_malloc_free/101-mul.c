...
/**
 * _calloc - to allocates a memory
 * @bytes: bytes of memory
 * @size: size in bytes elt
 * Return: pointer
 */
...
/**
 * add_arrays - adds 2 arrays
 * @mul_result: pointer to array
 * @sum_result: pointer to array
 * @len_r: length of arry
 * Return: void
 */
...
/**
 * print_me - prints array
 * @sum_result: pointer to int array
 * @len_r: length
 * Return: void
 */
